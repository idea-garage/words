...
class WordsRandomTable extends SupabaseTable<WordsRandomRow> {
  @override
  String get tableName => 'words_random';

  @override
  WordsRandomRow createRow(Map<String, dynamic> data) => WordsRandomRow(data);
}

class WordsRandomRow extends SupabaseDataRow {
  WordsRandomRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WordsRandomTable();
